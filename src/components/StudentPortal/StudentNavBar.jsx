      ...
      >
        <Toolbar>
          <IconButton
            ...
            sx={{ mr: 2 }}
          >
            <img src={dashboard} className="w-5 text-white"></img>
          </IconButton>
          <Typography
            variant="h6"
            noWrap
          ...
          {/* <Search>
            ...
            <StyledInputBase
              placeholder="Search for Danor Summary List, Sponsored Students, Donation Management"
          ...
          <Box sx={{ display: { xs: "none", md: "flex" } }}>
            {/* <IconButton
              ...
              color="inherit"
            >
              <Badge badgeContent={8} sx={{ backgroundClip: "#148581" }}>
                <img
                  src={notification}
                  style={{
                    width: "18px",
