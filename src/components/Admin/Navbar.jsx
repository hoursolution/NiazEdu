...
import { Tooltip, Grid, Select, FormControl, InputLabel } from "@mui/material";
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <img src={dashboard} alt="Dashboard" className="w-4 text-white" />
          </IconButton>
